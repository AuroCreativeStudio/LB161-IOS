                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'jm668g9w' /* We value your feedback and sug... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      await launchUrl(Uri(
                                        scheme: 'mailto',
                                        path: 'getcreative@auroinnovations.com',
                                      ));
                                    },
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '9yfo1v5m' /* getcreative@auroinnovations.co... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
