...
import 'editchapter_model.dart';
export 'editchapter_model.dart';
...
class EditchapterWidget extends StatefulWidget {
  ...
  static String routeName = 'editchapter';
  static String routePath = 'editchapter';
...
class _EditchapterWidgetState extends State<EditchapterWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditchapterModel());
    ...
    _model.regnoTextController ??=
        TextEditingController(text: widget.chapter?.lodgeRegNo);
    _model.regnoFocusNode ??= FocusNode();

    _model.grandRankTextController ??=
        TextEditingController(text: widget.chapter?.grandRank);
    _model.grandRankFocusNode ??= FocusNode();

    _model.year1TextController ??=
        TextEditingController(text: widget.chapter?.year1);
    _model.year1FocusNode ??= FocusNode();

    _model.regionalRankTextController ??=
        TextEditingController(text: widget.chapter?.regionalRank);
    _model.regionalRankFocusNode ??= FocusNode();

    _model.year2TextController ??=
        TextEditingController(text: widget.chapter?.year2);
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            '0vjvwp6a' /* Edit Chapter information */,
          ),
                  ...
                  children: [
                    Expanded(
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.chapter!.reference
