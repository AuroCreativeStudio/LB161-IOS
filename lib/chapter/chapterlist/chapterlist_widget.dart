...
import 'chapterlist_model.dart';
export 'chapterlist_model.dart';
                        ...
                        Form(
                          ...
                          child: StreamBuilder<List<ChapterRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<ChapterRecord> dropDown1ChapterRecordList =
                                  snapshot.data!;

                              return FlutterFlowDropDown<String>(
                                controller: _model.dropDown1ValueController ??=
                                    FormFieldController<String>(null),
                                options: dropDown1ChapterRecordList
                                    .map((e) => e.memberName)
                                    .toList(),
                  ...
                  child: StreamBuilder<List<ChapterRecord>>(
                    stream: queryChapterRecord(
                      queryBuilder: (chapterRecord) => chapterRecord.where(
                        'member_name',
                        isEqualTo: _model.dropDown1Value,
                      ),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
