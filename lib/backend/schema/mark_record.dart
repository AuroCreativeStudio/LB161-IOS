...
class MarkRecord extends FirestoreRecord {
  MarkRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('mark');

  static Stream<MarkRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => MarkRecord.fromSnapshot(s));

  static Future<MarkRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => MarkRecord.fromSnapshot(s));

  static MarkRecord fromSnapshot(DocumentSnapshot snapshot) => MarkRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static MarkRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      MarkRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'MarkRecord(reference: ${reference.path}, data: $snapshotData)';
...
Map<String, dynamic> createMarkRecordData({
  String? title,
  String? memberName,
  String? lodgeRegNo,
...
class MarkRecordDocumentEquality implements Equality<MarkRecord> {
  const MarkRecordDocumentEquality();

  @override
  bool equals(MarkRecord? e1, MarkRecord? e2) {
  ...
  @override
  int hash(MarkRecord? e) => const ListEquality().hash([
        e?.title,
        e?.memberName,
        e?.lodgeRegNo,
        e?.userRef,
  ...
  @override
  bool isValidKey(Object? o) => o is MarkRecord;
}
