...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00B1E1);
  late Color secondary = const Color(0xFFED1E24);
  late Color tertiary = const Color(0xFF8FCA77);
  late Color alternate = const Color(0xFF014894);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF999999);
  ...
  late Color prussianBlue = Color(0xFF112E44);
  late Color marigold = Color(0xFFF0A202);
  late Color turquoiseGreen = Color(0xFF94DDBC);
  late Color cerise = Color(0xFFDA4167);
  late Color fireOpal = Color(0xFFEB5E55);
  late Color lightGrey = Color(0xFFDCDFFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF014894);
  late Color secondary = const Color(0xFFFDCE07);
  late Color tertiary = const Color(0xFF8FCA77);
  late Color alternate = const Color(0xFF014894);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
